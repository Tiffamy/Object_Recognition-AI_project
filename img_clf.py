...
parser.add_argument("--model", default="resnet18", type=str, choices=["resnet18"], help="Which model you want to use.")
...
print("The prediction of our model is {}".format(Class))
